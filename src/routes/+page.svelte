<script lang="ts">
	...
	import Information from '$lib/components/icons/Information.svelte';
...
<div>
	<Tabs.Root value="friday">
        <div class="mx-auto my-5 flex w-full flex-col items-center justify-center gap-6 md:max-w-sm">
            <Tabs.List>
